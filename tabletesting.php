	...
	function displaydata($query){	
		...
		<table id='fixTable' class='table'>
		  ...
		  <tr>
			...
			<th class='col10'><a href=process1.php?sort=april&month=1&year=".$GLOBALS["year"].">APRIL</a></th>
			<th class='col11'><a href=process1.php?sort=may&month=1&year=".$GLOBALS["year"].">MAY</a></th>
			<th class='col12'><a href=process1.php?sort=june&month=1&year=".$GLOBALS["year"].">JUNE</a></th>
			<th class='col13'><a href=process1.php?sort=july&month=1&year=".$GLOBALS["year"].">JULY</a></th>
			<th class='col14'><a href=process1.php?sort=aug&month=1&year=".$GLOBALS["year"].">AUG</a></th>
			<th class='col15'><a href=process1.php?sort=sept&month=1&year=".$GLOBALS["year"].">SEPT</a></th>
